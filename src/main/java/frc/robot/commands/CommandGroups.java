...
public class CommandGroups {
    ...
    public static Command aimAndShoot(ShootSubsystem shootSubsystem, Drivetrain m_robotDrive,
            IndexSubsystem indexSubsystem, LimlihSubsystem limlihSubsystem, CommandXboxController driverController,
            ArmAngleSubsystem armAngleSubsystem) {

        return new SequentialCommandGroup(

                new ParallelCommandGroup(
                        new CenterOnTargetCommand(limlihSubsystem, m_robotDrive, 4, driverController),
                        new ShooterAimCommand(limlihSubsystem, armAngleSubsystem).withTimeout(1.5)

                ),

                new ParallelCommandGroup(
                        new ShootCommand(shootSubsystem).withTimeout(7),
