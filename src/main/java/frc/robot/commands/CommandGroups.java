...
public class CommandGroups {
    ...
    public static Command highScore(ArmExtensionSubsystem armExtensionSubsystem,
    ...
    public static Command midScore(ArmExtensionSubsystem armExtensionSubsystem,
            ArmRotationSubsystem armRotationSubsystem, ClawSubsystem clawSubsystem, WristSubsystem wristSubsystem) {
    ...
    public static Command lowScore(ArmExtensionSubsystem armExtensionSubsystem,
            ArmRotationSubsystem armRotationSubsystem, ClawSubsystem clawSubsystem, WristSubsystem wristSubsystem) {
    ...
    public static Command portalSnag(ArmExtensionSubsystem armExtensionSubsystem,
            ArmRotationSubsystem armRotationSubsystem, ClawSubsystem clawSubsystem, WristSubsystem wristSubsystem) {
    ...
    public static Command floorSnag(ArmExtensionSubsystem armExtensionSubsystem,
            ArmRotationSubsystem armRotationSubsystem, ClawSubsystem clawSubsystem, WristSubsystem wristSubsystem,
    ...
    public static Command totalZero(ArmExtensionSubsystem armExtensionSubsystem,
    ...
    public static Command autoDroptomousPrime(ArmExtensionSubsystem armExtensionSubsystem, ClawSubsystem clawSubsystem,
    ...
    public static Command lowBoop(ArmExtensionSubsystem armExtensionSubsystem, ClawSubsystem clawSubsystem) {
