...
import frc.robot.commands.shootCommands.IDFlywheelCommand;
...
import frc.robot.commands.driveCommands.ResetOdometryTargetSpaceCommand;
...
public class RobotContainer {
  ...
  public RobotContainer(Drivetrain drivetrain) {
    ...
    NamedCommands.registerCommand("intake", CommandGroups.intakeWithLineBreakSensor(intakeSubsystem, indexSubsystem, lineBreakSensorSubsystem));
