...
public class LightUnderGlowSubsystem extends SubsystemBase{
    ...
    public LightUnderGlowSubsystem() {
        addressableLED = new AddressableLED(2);
    ...
    public void blank() {
        brightness = 0;
        for (int i = 0; i < addressableLEDBuffer.getLength(); i++) {
            Color8Bit collor = addressableLEDBuffer.getLED8Bit(i);
            savedColors.add(i, collor);
    ...
    public void lightsOn() {
        brightness = 128;
        for (int i = 0; i < addressableLEDBuffer.getLength(); i++) {
            Color8Bit collor = savedColors.get(i);
            if (collor != null) {
                float[] hsvVals = Color.RGBtoHSB(collor.red, collor.green, collor.blue, null);
