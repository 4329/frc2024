...
public class PoseEstimationSubsystem extends SubsystemBase implements LoggedSubsystem {
  ...
  public PoseEstimationSubsystem(
      Drivetrain drivetrain, VisionSubsystem visionSubsystem, ArmAngleSubsystem armAngleSubsystem) {
  ...
  private void updateEstimation() {
    ...
    if (visionSubsystem.seeingAnything()) {
      //    estimator.addVisionMeasurement(visionSubsystem.getRobotPose(),
    ...
    Logger.recordOutput(
        ...
        new Pose3d[] {
          ...
          new Pose3d(
              ...
              new Rotation3d(
                  0,
                  (2 * Math.PI) - armAngleSubsystem.getAngleRadians() + shooterYawOffset,
                  0)), // Shootdexer
