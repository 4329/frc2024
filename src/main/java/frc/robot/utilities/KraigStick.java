...
public class KraigStick extends GenericHID {
   ...
   */
  public KraigStick(final int port) {
    super(port);
  ...
  public boolean getBackTrigger() {
    return getRawButton(Button.kbackTrigger.value);
  }

  public BooleanEvent backTrigger(EventLoop loop) {
    return new BooleanEvent(loop, this::getBackTrigger);
  }
